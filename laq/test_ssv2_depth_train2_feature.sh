...
CUDA_VISIBLE_DEVICES=2 python3 inference_sthv2_feature.py \
    --input_file /datasets/ssv2/nips/depth_train_shard2.jsonl \
    --dist_number 1 \
    --codebook_size 8 \
    ...
    --unshuffled_jsonl /datasets/ssv2/nips/z_depth_train_shard2.jsonl \
    --feature_dir /datasets/ssv2/nips/features_depth_stage1/z_depth_train_shard2 \
