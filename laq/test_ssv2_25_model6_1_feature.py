...
class FeaturePartWriter:
    ...
    def flush(self, force=False):
        ...
        if len(self.buffer["z_rgb_indices_input"]) == n:
    ...
    def save_manifest(self, args, output_jsonl_path):
        manifest = {
            ...
            "model_definition": (
                "Model6.1 / Stage 2.5: depth1 + z_rgb_feature_input "
            ...
            "feature_definition": {
                ...
                "z_depth_feature_pred": (
                    "Predicted/refined feature output from Stage 2.5 Model 6.1."
                ),
                "confidence": (
...
def run_inference(args):
        ...
        with torch.no_grad():
            for batch_idx, batch in enumerate(loader):
                ...
                for i in range(batch_size):
                    ...
                    if args.save_model_feature_jsonl:
    ...
    print(f"Done. Wrote model6.1 features to: {args.feature_output_dir}")
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Inference for LAPA-depth Stage 2.5 Model 6.1, "
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Output directory for model6.1 feature .pt files.",
    )

    parser.add_argument(
        "--feature_prefix",
        type=str,
        default="stage25_model6_1_feature",
