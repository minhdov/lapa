...
parser = argparse.ArgumentParser(
    description="LAQ inference for RGB images, saving z_rgb_indices and z_rgb_feature"
)
...
parser.add_argument(
    ...
    type=str,
    required=True,
    help="Output directory for z_rgb_feature .pt parts and manifest",
)
parser.add_argument(
    "--feature_prefix",
    type=str,
    default="z_rgb_stage1",
...
class AsyncRGBDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Output shape per sample: [3, 2, 256, 256]
...
def process_data(
    ...
    for img_batch in tqdm(dataloader):
        ...
        for idx in range(batch_start, batch_end):
            ...
            feature_buffer["rgb_pair"].append(image_paths[idx])
            feature_buffer["z_rgb_indices"].append(index_batch[index])
            feature_buffer["z_rgb_feature"].append(feature_batch[index])
            ...
            if args.save_z_rgb_tokens:
                ...
                feature_buffer["z_rgb_tokens"].append(token_batch[index])
