...
from laq_model import LAQStage25TrainerModel4
...
z_depth_feature_manifest = (
    "/datasets/ssv2_libero_90/stage2_z_rgb_ssv2_libero90/"
    "z_depth_train_mixed_manifest_gt.json"
)
...
trainer = LAQStage25TrainerModel4(
    ...
    results_folder="results_model4_zrgb_ssv2_libero90_to_zdepth_feature_corl_gt",
    lr=1e-4,
    ...
    wandb_run_name="model4_zrgb_ssv2_libero90_to_zdepth_feature_gt",
    save_best=True,
    best_metric="loss",
)
