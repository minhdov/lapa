...
CUDA_VISIBLE_DEVICES=0 python3 inference_sthv2_feature.py \
    ...
    --debug_save_dir outputs/debug_depth_libero_shard0_mini \
    --debug_num_samples 10 \
    --unshuffled_jsonl /datasets/libero3/z_depth_train_shard0.jsonl \
    --feature_dir /datasets/libero3/features_depth_stage1/z_depth_train_shard0 \
    --feature_prefix z_depth_train_shard0_stage1 \
    --feature_part_size 10000
