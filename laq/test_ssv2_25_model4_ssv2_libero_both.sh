  ...
  --checkpoint results/results_model4_depth_rgb_to_zdepth_feature_libero_ssv2/model4.65000.pt \
  ...
  --feature_output_dir /datasets/ssv2_libero_90/stage25_model_4_val_libero10_new/z_depth_val \
