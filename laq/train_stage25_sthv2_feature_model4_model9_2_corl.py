...
z_rgb_feature_manifest = "/datasets/ssv2_libero10_stage25_model2_model9_1_9_2/z_rgb_train_mixed_manifest_correct_2022990.json"
z_depth_feature_manifest = "/datasets/ssv2_libero10_stage25_model2_model9_1_9_2/z_depth_train_model_1_1_depth_manifest.json"
z_depth_path = "/datasets/ssv2_libero10_stage25_model2_model9_1_9_2/z_depth_train_model_1_1.jsonl"
...
trainer = LAQStage25TrainerModel4(
    ...
    results_folder="/outputs/results_stage25_final_feature_model4_model9_2_ssv2_libero90",
    lr=1e-4,
    save_model_every=5000,
    log_every=100,
    num_workers=16,
    pin_memory=False,
    wandb_project="lapa_depth_model4_model9_2",
    wandb_run_name="results_stage25_final_feature_model4_model9_2_ssv2_libero90",
    save_best=True,
    best_metric="loss",
)
