...
CUDA_VISIBLE_DEVICES=1 python train_stage25_sthv2_feature_model2_percent.py --data_percent 10 \
  > /outputs/train_stage25_sthv2_feature_model2_percent_10.log 2>&1
' > /outputs/train_stage25_sthv2_feature_model2_percent_20_then_10.wrapper.log 2>&1 < /dev/null &


# 40% xong rồi chạy 60%
nohup bash -lc '
CUDA_VISIBLE_DEVICES=3 python train_stage25_sthv2_feature_model2_percent.py --data_percent 40 \
...
' > /outputs/train_stage25_sthv2_feature_model2_percent_40_then_60.wrapper.log 2>&1 < /dev/null &


# 80% chạy riêng
nohup bash -lc '
CUDA_VISIBLE_DEVICES=8 python train_stage25_sthv2_feature_model2_percent.py --data_percent 80
